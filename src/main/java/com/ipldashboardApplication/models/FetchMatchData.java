...
public class FetchMatchData {
	...
	public String toString() {
		return "FetchMatchData [id=" + id + ", city=" + city + ", team1=" + team1 + ", team2=" + team2  + ", date=" + date + ", teamWinner=" + teamWinner + ", playerOfMatch=" + playerOfMatch
				+ ", venue=" + venue + ", neutralVenue=" + neutralVenue + ", tossWinner=" + tossWinner
				+ ", tossDecesion=" + tossDecision + ", result=" + result + ", resultMargin=" + resultMargin
				+ ", eliminator=" + eliminator + ", method=" + method + ", umpire1=" + umpire1 + ", umpire2=" + umpire2
				+ "]";
	}
